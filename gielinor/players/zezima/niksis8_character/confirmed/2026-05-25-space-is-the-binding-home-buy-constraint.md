# Space/layout — not legal form or price — is Niklavs' binding home-buy constraint

**Observation.** Across the apartment hunt, the factor that actually *decides* every flat for
...
- A **WFH station is a hard requirement, not a nice-to-have.** A renovated pre-war 2-room at his
  ...
  His real spec is probably a **3-room or a flexible-layout 2-room** (alcove, wide hall, high-ceiling
  loft nook). When advising on his next search, **lead with the work-space/layout test**, not price
  or charm — and frame the legal/latent risks as secondary to the daily-friction ones (a missing
  desk is felt every working day; CL 1074 may never fire).
