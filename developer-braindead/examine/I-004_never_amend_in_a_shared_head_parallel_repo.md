...
**Related.** [[D-024_parallel_player_coordination]] (parallel session coordination — the shared-state regime this lesson lives under), [[I-002]] (render/verify before shipping — sibling build-discipline posture), `bank/build-lessons.md` (the carried-lessons digest; the S038 "shared global state is hostile to parallel sessions" family).
