...
**Last updated.** 2026-05-22 (end of [[S039]] — switchboard zombie GC + cascading actor resolver + instance-slot reclaim. Three layered fixes for "switchboard shows everyone UNKNOWN" plus the "braindead-17" instance drift. Prior carries: [[S038]] promote/consult loop; [[S033]] visualizer audit + 12 fixes; [[S034]] Guthix consultation mode; [[S037]] switchboard Phase 3 click-to-focus.).
