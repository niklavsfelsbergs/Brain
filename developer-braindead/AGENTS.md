<!-- GENERATED from developer-braindead/CLAUDE.md by tools/sync_agents_md.py — DO NOT EDIT.
     ...
     @import, so the rulebook must be inlined physically here. Edit developer-braindead/CLAUDE.md
