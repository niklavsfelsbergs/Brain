...
- Landed the full design as [[D-014]]. Three implementation surfaces (hook, renderer, protocol); recommended splitting into smaller PRs when the next session picks it up. Also flagged the protocol-doc drift `wisp.txt` → `braindead.txt` as part of D-014's protocol additions.
...
**Cascade.** [[D-014]] (new), this quest log entry, `respawn.md` updated.
