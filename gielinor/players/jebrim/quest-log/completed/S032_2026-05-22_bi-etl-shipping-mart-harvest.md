...
- **Committed + pushed.** `picanova/bi-analytics@2406916` — "shipping-agent: data caveats from bi-etl harvest ([[S031_2026-05-22_temp-tracking-missing-orderitems|S031]])" (commit subject says [[S031_2026-05-22_temp-tracking-missing-orderitems|S031]] because SNNN wasn't computed yet at commit time; close-session resolved to S032).
