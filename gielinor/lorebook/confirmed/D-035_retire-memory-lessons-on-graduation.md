...
> **Status:** confirmed (promoted from draft 2026-06-18, S271, principal-authorized). Founding observation: bankstanding [[B-020_2026-06-18_memory-cap-trim-and-graduation-retire|B-020]]. Implemented same arc by [[S271_9d93fcd1_quest_graduation_detector_and_trace_home|S271]] (the quest-graduation detector is the episodic-memory sibling of this rule's lesson-store reconcile).
