...
**The change is NOT DBS-only (a global eligibility rule).** Measured on the 3.2.0 Q1 cost matrix: **20,171** parcels lose Maersk-EU eligibility vs pure-girth, of which **13,170 (65%) are currently on NON-DBS carriers** (UPS/other incumbents), 7,001 on DBS. A carrier engine's eligibility rule reshapes the *whole-book* routing, not just the reroute slice it was prompted by — the bigger saving effect was non-DBS oversize parcels re-homing off Maersk-EU to pricier carriers. **Annual roll-up:** €997,720/yr (7%), band €969k–€1,026k (`annual_2026/`, rebuilt on 3.2.0).
