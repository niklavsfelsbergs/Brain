...
export function Board({
  ...
  return html`
    <aside class="board-col">
      <header class="topbar">
        <h1>SWITCHBOARD<span style="font-size:9px;opacity:.45;font-weight:400;letter-spacing:0;margin-left:5px;" title="cockpit build tag — confirms fresh code loaded after relaunch">b88.1</span></h1>
        <span class="count">
