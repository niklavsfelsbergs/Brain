...
- bank/notes/projects: `scm_nextjs_duckdb_oom_modes.md` — DuckDB's two OOM modes (RAM cap vs temp-spill on a constrained disk); the two `:memory:` connections; 20Gi pod headroom. S097, ties [[S069]].
