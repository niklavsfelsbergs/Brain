...
corpus:
  ...
  - bank/notes/projects/2026-06-12-eu-tender-mix1-q4-seasonality-measured-flat.md
  - bank/notes/projects/2026-06-12-eu-tender-no-hermes-routing-report.md
...
**Post-presentation adds (2026-06-12):** no-Hermes routing report rendered at cell grain (€976,024/yr, parametrize-don't-fork build) → [[2026-06-12-eu-tender-no-hermes-routing-report]]; its €88.5k headline-vs-flow-split gap reconciles to the canonical (Direct Link exit −€47,305 + Q4 peak −€41,194) → [[2026-06-12-eu-tender-no-hermes-v2-headline-vs-flow-split-reconciliation]]. **Güll marginal collapses to ~€0/yr** once density is grounded (the +€163,897 paper / +€163,097 built figure rode an unvalidated 150/pallet; corrected 150→52/75 → +€520/yr) — parked on cost, pending the inbound-sprinter-sharing lever; **Austrian Post still carries the same unvalidated 150/pallet** → [[2026-06-12-guell-no-hermes-marginal-and-density-gate]]. Mid-year go-live banks **volume-share not calendar-share** (the November cliff) → [[2026-06-12-go-live-stub-year-realization]]; Mix-1 Q4 seasonality measured-flat (annualization mix-invariant) → [[2026-06-12-eu-tender-mix1-q4-seasonality-measured-flat]].
