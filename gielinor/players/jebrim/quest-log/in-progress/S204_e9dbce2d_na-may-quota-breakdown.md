...
- 2026-06-11 (post-close, L-002 chase on Niklavs's cue): ORWO_80x60 did NOT revert to the WICKEL box. Article-grain trace (DIGI-80X60%, after sku proved product-level and format_key 100% NULL): product folded into WICKELVERPACKUNG **100x75_AE** mid-May (6,218/850 → 2,288/5,120 → 0/3,667 by month). Girth 224→262cm; May same-month invoiced single-item delta +€0.97/parcel (+13.5%) ≈ €12k/mo pace — June invoices to confirm (early subset reads cheaper). Open: PCS PL ops — priced decision or config accident (bundle with zV-130cm). Ledger/briefing updated, committed 31a7d3f. Method note for v2: the dims→weight→article-grain escalation IS the drill stage from README roadmap item 1 — worked as designed. (Also: restored the finance-message header below, which my earlier edit had eaten.)

- 2026-06-11 (post-close, L-002 basket investigation on Niklavs's "fuck, run an investigation"): basket-signature trace (LISTAGG via NFE shared.database — redshift MCP validator can't parse LISTAGG WITHIN GROUP) over 59,461 ships. CONFIRMED same baskets in bigger box: 55% of June 100x75_AE volume = ex-ORWO_80x60 signatures; the box elimination upsized a whole mid-format family (DIGI-80X60/KLAS-75X50/QUAD-60X60/PAN1-80X40). Identical-basket invoiced delta **+€1.26/parcel weighted ≈ €185k/yr pace** (supersedes €0.97/€140k single-article estimate). Ledger L-002 → fuckup-unless-priced; investigations/l002_{basket_trace.py,findings.md}; committed 32d6779. Open: PCS PL ops priced-decision question; June-invoice re-confirm.

- 2026-06-11 (second close): Niklavs commissioned the L-002 finding as a full NFE shipping topic with an HTML final report (same-baskets-pricier-box evidence + migration-timing charts) — HANDED OFF to next session via `inventory/box-consolidation-topic-resume__e9dbce2d.md` (complete brief: established findings, what to build, files to read). v2 project state saved clean (committed through 32d6779).

## Final finance message (delivered in chat 2026-06-11, post-correction)
