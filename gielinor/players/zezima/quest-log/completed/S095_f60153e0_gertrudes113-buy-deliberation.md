...
- Ran **penguin P1** (lived-experience + financing re-test) → horror stories live in *unsorted* shares; flat 41 passes every separator; **financing fear CORRECTED** — banks demonstrably lend on shares in this building (contradicts the confirmed risk-model note).
- Ran **penguin P2** (price-fairness comps) → fair value ~€110–121k furnished, midpoint ~€115k; €114k bid squarely fair; €120k = top of fair (needs written furniture annex); walk >€121k.
- Principal surfaced the real residual: the immediate **location is visually ugly** (not *where*, but how it looks) — and a frame: **buy as a 3–5yr flip**, save €18–30k rent, sell ~without a loss.

## Decisions / conclusions
- **Every researchable dimension cleared:** title (clean), lived-experience (sorted share), financing (corrected — banks lend here), price (fair).
- **Residual is a values call only:** accept a share + capped upside + governance grind + the ugly outlook, for a flat he likes, in Avoti.
- **Flip frame is sound, with caveats:** a share is the weakest vehicle for a *timed* exit (slower resale lands exactly at cash-out); "save €18–30k rent" is gross (carrying costs, esp. mortgage interest, net it down); enter at fair (~€114–117k, not €120k) for "no loss" to be robust.
- The ugliness is the one non-researchable factor; only Niklavs's eyes *from the flat* close it.

## Artifacts
- Decision record (full detail): `bank/drafts/notes/latvia-property/2026-05-26-gertrudes113-folio-5262-gate2-closed.md`
- Research: `research/2026-05-26-domajamas-dalas-lived-experience-and-financing-recheck.md`; `research/2026-05-26-gertrudes113-price-fairness-comps.md`
- Penguin run-logs: `quest-log/completed/S095_p1_domajamas-dalas-lived-experience.md`, `S095_p2_gertrudes113-price-comps.md`
- Resume: `inventory/gertrudes113-resume__f60153e0.md`
