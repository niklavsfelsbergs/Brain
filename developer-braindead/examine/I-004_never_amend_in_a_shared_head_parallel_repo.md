...
**Related.** [[D-024]] (parallel session coordination — the shared-state regime this lesson lives under), [[I-002]] (render/verify before shipping — sibling build-discipline posture), `bank/build-lessons.md` (the carried-lessons digest; the S038 "shared global state is hostile to parallel sessions" family).
