# D-002 — 2026-05-20 — Dev brain folder name: `developer-braindead`

**Context.** Needed a folder name that distinguishes the dev brain from `vault/` (main brain) and signals "meta, not content."
