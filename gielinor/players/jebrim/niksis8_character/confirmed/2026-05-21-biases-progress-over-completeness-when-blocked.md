...
**How to apply.** Surface blocked-vs-buildable split rather than sitting in hold. Build with status blocks rather than waiting for clean inputs. Keep unstable parts narrowly scoped so the patch is mechanical.

**Counter-cue.** If he says "wait" or "hold on" explicitly, hold. The bias is a default, not a rule.

**Inverts.** When *I* am blocked on principal input, ask the smallest unblocking question rather than guess.

## Related

- [[moving-target-decomposition]] — the skill this preference shapes.
