...
**Rule.** Before reviewing a deliverable Niklavs built, check the resume files and quest logs for what *else* was running in parallel. The portfolio context is the rubric. A deliverable that looks 7/10 against a clean runway looks 9/10 against the actual conditions, and Niklavs is calibrated to the second number. Lead the verdict with both — artifact quality *and* what it took to get there. Skipping the second invites the "you have no idea what it's like" correction.

**Adjacent.** This is work-character. Whether the same pattern holds for Zezima-territory work (personal-life thinking, open-ended reflection) is unclear — preserve scope to Jebrim until a Zezima session reproduces the pattern. **Self-check before promoting:** would this be true for any player? Probably not — the "1-2 months of cross-team coordination" frame is specifically work-shaped. Stays in niksis8_character.
