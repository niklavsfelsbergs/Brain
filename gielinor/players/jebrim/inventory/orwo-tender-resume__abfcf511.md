...
Next = (a) **re-baseline comparison to do-nothing(today + GRI)** — PRIORITY, needs the ORWO GRI% (chase: published 2026 UPS DE GRI or the contract escalation clause), (b) cut-below-today AT ask, (c) competitor offers (DHL/AT-Post/Güll/GLS/Maersk) same machinery, (d) refine annualization (seasonal ratios), (e) DHL Phase 2. NFE 7_ORWO_tender_2026/ uncommitted (his call); bi-etl 5ab0322c2 local-unpushed.
---
