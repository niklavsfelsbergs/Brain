...
**Cascade.** Dev-brain: this quest log, `respawn.md` (S083 prepend + state refresh), `comms/active.md` (OPEN/UPDATEs/CLOSING), `bank/build-lessons.md` (3 S083 lessons). Cross-project memory: `feedback-instrument-dont-reguess`, `feedback-autonomous-verify-what-you-can`. **Main-brain changes (`gielinor/`):** none.
**Cockpit commits (7):** e04c679 terminal re-pin/hardening · f5222d1 backend crash-guard · f8d54c0 dead --closing var · dc6b0ca regression test · 317ac42 busy→idle decay · 04848db Shift+Enter preventDefault+diag · 642db9c instant Esc-clear. Plus 3 dev-bookkeeping commits.
