...
- `cost_matrix.py` (Hermes wired L74; full-year partitioned build, S120).

## Engine snapshot
- Version `hermes-2.0.0` (S103, 2026-05-27, Round-1 reply rebuild). Services: paket_de_hd (DE, 31.5 kg cap), paket_intl_hd (25 EU, 30 kg cap). HD-only; CH excluded (country_not_served).
